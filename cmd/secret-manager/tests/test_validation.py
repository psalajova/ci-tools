...
def run_validation_cases(validator_func, test_cases, validator_name):
...
def main():
    ...
    run_validation_cases(validate_collection, collection_tests, "validate_collection")
    run_validation_cases(validate_secret_name, secret_tests, "validate_secret_name")
    run_validation_cases(validate_group_name, group_tests, "validate_group_name")
